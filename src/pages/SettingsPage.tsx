...
export default function SettingsPage() {
  ...
  const [bookkeepingSettings, setBookkeepingSettings] = useState(() => ({ voucherSeries: "A", defaultVatMethod: "Faktureringsmetoden", resultAccount: "2099", roundingAccount: "3740", fiscalLockReminder: true }));
